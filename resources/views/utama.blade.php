...
<body>
    ...
    <header id="header" class="fixed-top  header-transparent ">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <div class="logo">
                <h1><a href="{{ route('utama') }}">INFO-SISKOM</a></h1>
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a class="nav-link scrollto" href="{{ route('register') }}">Info</a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 d-lg-flex flex-lg-column justify-content-center align-items-stretch pt-5 pt-lg-0 order-2 order-lg-1"
                    ...
                    <div>
                        <h1>Hai Siskomers</h1>
                        <h2>Selamat Datang di Prodi Rekayasa Sistem Komputer</h2>
                        <p>Jangan Lupa Tetap Mematuhi Peraturan Yang Ada</p>
                        <div class="content d-flex flex-column justify-content-center">
                            <div class="col-md-6 icon-box" data-aos="fade-up">
                                <p><i class="fa-solid fa-mask-face"></i> Memakai Pakaian Yang Rapih</p>
                            </div>
                            <div class="col-md-6 icon-box" data-aos="fade-up">
                                <p><i class="fa-solid fa-people-group"></i> Datang Tepat Waktu</p>
                            </div>
                            <div class="col-md-6 icon-box" data-aos="fade-up">
                                <p><i class="fa-solid fa-people-arrows-left-right"></i> Menjaga Ketertiban</p>
                            </div>
                            <div class="col-md-6 icon-box" data-aos="fade-up">
                                <p><i class="fa-solid fa-pump-soap"></i> Menjaga Kebersihan</p>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="section-title mb-5">
                    ...
                    <div class="dropdown show d-flex justified">
                        <a style="background: #143454;color: white !important" class="btn dropdown-toggle"
                                ...
                                <div data-aos="fade-up" class="table-responsive mt-2 ">
                                    ...
                                    @else
                                        <table id="datatablesSimple" class="table table-striped table-hover ">
                                            <thead>
                                                <tr>
                                                    <th style="background-color: #143454; color: white">Mahasiswa</th>
                                                    <th>Jam</th>
                                                    <th>Judul</th>
                                                    <th>Jenis Seminar</th>
                                                    <th>Ruang</th>
                                            ...
                                            <tbody>
                                                @foreach ($jadwal->slice(0, 5) as $jw)
                                                    <tr>
                                                        ...
                                                        <td>{{ $jw->pembimbing1_id ? $jw->pembimbing1->nama_dosen : '-' }}
                                                        </td>
                                                        <td>{{ $jw->pembimbing2_id ? $jw->pembimbing2->nama_dosen : '-' }}
                                                        </td>
                                                        <td>{{ $jw->penguji1_id ? $jw->penguji1->nama_dosen : '-' }}
                                                        </td>
                                                        <td>{{ $jw->penguji1_id ? $jw->penguji1->nama_dosen : '-' }}
                                                        </td>
                                                    </tr>
    ...
    <footer id="footer">
        ...
        <section id="footer" class="content d-flex flex-column justify-content-center">
            ...
            <img data-aos="fade-up" class="content d-flex flex-column justify-content-center"
                src="{{ asset('img/footer.png') }}" alt="">

        </section>

        <div class="container py-4">
            <div class="copyright">
                &copy; Copyright <strong><span>Rekayasa Sistem Komputer</span></strong>. All Rights Reserved
            </div>
            <div class="credits">
    ...
    <a href="#    " class="back-to-top d-flex align-items-center justify-content-center text-white"><i
